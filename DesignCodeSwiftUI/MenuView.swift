    ...
    var body: some View {
        HStack(spacing: 16.0) {
            Image(systemName: icon)
                ...
                .foregroundColor(Color(#colorLiteral(red: 0.5, green: 0.6223530251, blue: 0.7553076946, alpha: 1)))
    ...
    var body: some View {
        VStack {
            ...
            VStack {
                ...
                MenuRow(title: "Sign out", icon: "person.circle")
                    .onTapGesture {
